...
const Dialogs = (props) => {
    ...
    const dialogsElements = props.messagePage.dialogData.map(dialog => <DialogItem name={dialog.name} id={dialog.id}
                                                                                   url={dialog.pic}/>)
    const messagesElements = props.messagePage.messageData.map(message => <Message message={message.message}
                                                                                   id={message.id}/>)
    return (
